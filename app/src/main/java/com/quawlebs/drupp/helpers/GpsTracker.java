...
public class GpsTracker extends Service implements LocationListener {
    ...
    float speeds; // latitude

    double longitude; // longitude
    double finalSpeed; // longitude
    ...
    public double getSpeeds() {
        if (location != null) {
            ...
            double currentSpeed = round(speeds, 3, BigDecimal.ROUND_HALF_UP);
            finalSpeed = round((currentSpeed * 3.6), 3, BigDecimal.ROUND_HALF_UP);
