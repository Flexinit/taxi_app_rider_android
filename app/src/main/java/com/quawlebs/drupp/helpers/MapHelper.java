...
import static com.quawlebs.drupp.helpers.MarkerColors.AZURE;
import static com.quawlebs.drupp.helpers.MarkerColors.BLUE;
import static com.quawlebs.drupp.helpers.MarkerColors.CYAN;
import static com.quawlebs.drupp.helpers.MarkerColors.GREEN;
import static com.quawlebs.drupp.helpers.MarkerColors.MAGENTA;
import static com.quawlebs.drupp.helpers.MarkerColors.NONE;
import static com.quawlebs.drupp.helpers.MarkerColors.ORANGE;
import static com.quawlebs.drupp.helpers.MarkerColors.RED;
import static com.quawlebs.drupp.helpers.MarkerColors.ROSE;
import static com.quawlebs.drupp.helpers.MarkerColors.VIOLET;
import static com.quawlebs.drupp.helpers.MarkerColors.YELLOW;
...
public class MapHelper {
    ...
    public Marker addMarker(double latitude, double longitude, BitmapDescriptor bitmapDescriptor, boolean playAnimation) {
    ...
    public Marker addMarker(double latitude, double longitude, BitmapDescriptor bitmapDescriptor, float rotation, boolean playAnimation) {
        LatLng latLng = new LatLng(latitude, longitude);
        MarkerOptions markerOptions = new MarkerOptions()
                .position(latLng)
                .icon(bitmapDescriptor)
     ...
     * @param zoomLevel
     */
    public void zoomToLocation(double latitude, double longitude, float zoomLevel) {
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(new LatLng(latitude, longitude)).zoom(zoomLevel)
                .build();
        googleMap.animateCamera(CameraUpdateFactory
     ...
     * @param dLng
     */
    public void calculateETA(double cLat, double cLng, double dLat, double dLng) {
        class CalculateETA extends AsyncTask<Void,Void, Matrix>{
            private MapDirection mMapDirection;
            @Override
            protected Matrix doInBackground(Void... voids) {
    ...
    public void animateMarker(final Marker marker, final LatLng toPosition, float bearing, final boolean hideMarker) {
        final Handler handler = new Handler();
        final long start = SystemClock.uptimeMillis();
        Projection proj = googleMap.getProjection();
        Point startPoint = proj.toScreenLocation(marker.getPosition());
