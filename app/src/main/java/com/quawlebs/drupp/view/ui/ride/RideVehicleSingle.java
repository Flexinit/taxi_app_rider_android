...
public class RideVehicleSingle extends MainBaseFragment implements IDialogResponseObserver {
    private View micro, mini;
    ...
    private Button bookRide,scheduleRide;
    //private
    ...
    private View radioButtonRegular;
    private View radioButtonLuxury;
    ...
    protected void initViewsForFragment(View view) {
       ...
       // rideTypeSelector = view.findViewById(R.id.container_bottom);
        ...
        //mSource = view.findViewById(R.id.et_source);
        ...
        scheduleRide = view.findViewById(R.id.btn_schedule_ride);
        ...
        radioButtonRegular = view.findViewById(R.id.drawable_circle_regular);
        radioButtonLuxury = view.findViewById(R.id.drawable_circle_luxury);

    }

    @Override
    protected View inflateFragmentView(LayoutInflater inflater, ViewGroup container) {
        View view = inflater.inflate(R.layout.fragment_ride_vehicle_new, container, false);
...
//            bookRide.setClickable(false);
        ...
        scheduleRide.setOnClickListener(v -> {
...
//        getCalculatedFare();
    ...
    private void selectVehicle(View vehicle) {
...
//            kekeVehicle.setBackgroundColor(0x00000000);
            radioButtonRegular.setVisibility(View.VISIBLE);
            radioButtonLuxury.setVisibility(View.GONE);
            microVehicle.setSelected(true);
...
//            kekeVehicle.setBackgroundColor(0x00000000);
            radioButtonRegular.setVisibility(View.GONE);
            radioButtonLuxury.setVisibility(View.VISIBLE);
