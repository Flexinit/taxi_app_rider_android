...
public class CompletedBusRideFragment extends MainBaseFragment implements IAdapterItemClickListener {
    ...
    protected View inflateFragmentView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.completed_bus_ride_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        busRidesRecyclerView = view.findViewById(R.id.rv_completed_bus_rides);
        busRidesRecyclerView.setLayoutManager(new LinearLayoutManager(getmActivity()));
    ...
    private void getCompletedBusRide() {
        ...
        }, SessionManager.getAccessToken()).getCompletedBusRides();
    }
    ...
    public void onAdapterItemClick(View v, int position) {
        try {
            ...
            bundle.putInt(AppConstants.K_BUS_RIDE_ID, busInfoModels.get(position).getBusRideId());
            bundle.putInt(AppConstants.K_RIDE_TYPE, AppConstants.BUS_RIDE_COMPLETED);
