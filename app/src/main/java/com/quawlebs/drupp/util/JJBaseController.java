...
public abstract class JJBaseController {
    ...
    public static final float DEFAULT_ANIM_ENDF = 5;
    ...
    public ValueAnimator startSearchViewAnim(float startF, float endF, long time, final PathMeasure pathMeasure) {
        ...
        valueAnimator.addUpdateListener(valueAnimator1 -> {
            mPro = (float) valueAnimator1.getAnimatedValue();
            if (null != pathMeasure)
...
//                mState = STATE_ANIM_START;
                handler.postDelayed(() -> ((JJAroundCircleBornTailController) JJBaseController.this).resetAnim(),2000);
