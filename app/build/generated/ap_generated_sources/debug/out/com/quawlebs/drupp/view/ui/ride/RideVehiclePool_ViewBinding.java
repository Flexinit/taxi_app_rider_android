...
public class RideVehiclePool_ViewBinding implements Unbinder {
  private RideVehiclePool target;

  private View view7f0b015a;

  @UiThread
  public RideVehiclePool_ViewBinding(final RideVehiclePool target, View source) {
    this.target = target;
